package com.github.kyrenesjtv.springboot2.springboot2_withsecurity.springboot2_withsecurity.util;
...
public class StringUtil {
    ...
    /**
     * 将String字符串转换为日期格式yyyy-MM-dd HH:mm:ss
     *
     * @param date
     *             string to Date is yyyy-MM-dd HH:mm:ss.
     * @return
     */
